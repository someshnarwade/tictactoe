...
def add_coordinates(coords, state):
    ...
    if nested_state[coords[1] - 1][coords[0] - 1] in ('X', 'O'):
        ...
        nested_state[coords[1] - 1][coords[0] - 1] = 'X'
    c, b, a = nested_state
...
string = input('Enter cells: ').replace('_', ' ')
...
location = add_coordinates(coordinates, string)

while location == 'This cell is occupied! Choose another one!':
